...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Maio-2018 às 14:32
...
ALTER TABLE `tb_atendimento`
  ...
  ADD KEY `IND_ATD_CLI_ID` (`cli_id`),
  ADD KEY `IND_ATD_PRO_ID` (`pro_id`),
  ADD KEY `IND_ATD_SER_ID` (`ser_id`),
  ADD KEY `IND_ATD_MUN_ID` (`mun_id`);
...
ALTER TABLE `tb_cliente`
  ...
  ADD UNIQUE KEY `UNQ_CLI_LOGIN` (`cli_login`),
  ADD KEY `IND_CLI_MUN_ID` (`mun_id`);
...
ALTER TABLE `tb_pagamento`
  ...
  ADD KEY `IND_PAG_ATD_ID` (`atd_id`),
  ADD KEY `IND_PAG_FP_ID` (`fp_id`);
...
ALTER TABLE `tb_profissional`
  ...
  ADD UNIQUE KEY `UNQ_PRO_LOGIN` (`pro_login`),
  ADD KEY `IND_PRO_MUN_ID` (`mun_id`);
