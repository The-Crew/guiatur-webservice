...
--
-- Host: 10.129.76.12
-- Generation Time: 15-Jun-2018 às 03:19
...
`atd_id` int(11) NOT NULL,
  ...
  `atd_data_agendado` datetime NOT NULL,
  `atd_data_realizado` datetime NOT NULL,
  `atd_data_cadastro` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atd_endereco` varchar(255) NOT NULL,
  `atd_bairro` varchar(50) NOT NULL,
  `atd_cep` char(8) NOT NULL,
  `mun_id` int(11) NOT NULL,
  `atd_status` char(1) NOT NULL DEFAULT 'A',
  `atd_preco` double NOT NULL,
  `atd_desconto` double NOT NULL,
  `atd_custo_adicional` double NOT NULL DEFAULT '0',
  `atd_situacao_pagamento` char(1) NOT NULL DEFAULT 'P',
  `atd_custo_transporte` char(1) NOT NULL,
  `atd_observacao` text NOT NULL,
  `atd_avaliacao_data` datetime DEFAULT NULL,
  `atd_avaliacao_satisfacao` int(1) DEFAULT NULL,
  `atd_avaliacao_comentario` varchar(255) DEFAULT NULL
...
INSERT INTO `tb_atendimento` (`atd_id`, `cli_id`, `pro_id`, `ser_id`, `atd_data_agendado`, `atd_data_realizado`, `atd_data_cadastro`, `atd_endereco`, `atd_bairro`, `atd_cep`, `mun_id`, `atd_status`, `atd_preco`, `atd_desconto`, `atd_custo_adicional`, `atd_situacao_pagamento`, `atd_custo_transporte`, `atd_observacao`, `atd_avaliacao_data`, `atd_avaliacao_satisfacao`, `atd_avaliacao_comentario`) VALUES
(2, 2, 1, 1, '2018-06-15 12:00:00', '2018-06-09 00:00:00', '2018-06-03 20:30:19', 'Rua Teste, 999', 'Imbiribeira', '51222333', 2611606, 'R', 100, 0, 0, 'C', 'N', 'Observação teste.', '2018-06-09 00:00:00', 5, NULL),
(3, 14, 1, 1, '2018-06-23 00:00:00', '0000-00-00 00:00:00', '2018-06-07 23:42:42', 'Rua x', 'Vila do chaves', '54000000', 2611606, 'R', 0, 0, 0, 'C', '', '', '0000-00-00 00:00:00', NULL, NULL),
(4, 14, 1, 1, '2018-06-14 00:00:00', '0000-00-00 00:00:00', '2018-06-08 00:00:58', 'Rua r', 'Barro', '54123456', 2607604, 'R', 0, 0, 0, 'C', '', '', '0000-00-00 00:00:00', NULL, NULL),
(5, 14, 1, 1, '2018-06-19 00:00:00', '0000-00-00 00:00:00', '2018-06-08 00:05:12', 'Rua rrr', 'Bbbb', '54125415', 2600609, 'R', 0, 0, 0, 'C', '', '', '0000-00-00 00:00:00', NULL, NULL),
(6, 14, 3, 2, '2018-06-14 00:00:00', '2018-06-12 00:00:00', '2018-06-12 00:00:58', 'Rua r', 'Piedade', '54123456', 2607604, 'R', 50, 0, 0, 'C', '', '', '2018-06-12 00:00:00', 3, NULL),
(7, 14, 1, 1, '2018-03-01 08:00:00', '2018-03-01 00:00:00', '2018-06-14 22:24:35', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'C', 40, 0, 0, 'P', 'N', '', NULL, 4, NULL),
(8, 15, 2, 2, '2018-03-02 08:00:00', '2018-03-02 08:00:00', '2018-06-14 22:27:00', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'C', 40, 0, 0, 'P', 'N', '', NULL, 5, NULL),
(9, 16, 3, 3, '2018-03-03 08:00:00', '2018-03-03 08:00:00', '2018-06-14 22:28:10', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-03-03 08:00:00', 1, NULL),
(10, 17, 4, 1, '2018-03-04 08:00:00', '2018-03-04 08:00:00', '2018-06-14 22:28:44', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-04 08:00:00', 2, NULL),
(11, 18, 5, 2, '2018-03-05 08:00:00', '2018-03-05 08:00:00', '2018-06-14 22:33:12', 'Rua Teste, 999', 'Boa Viagem', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-05 08:00:00', 4, NULL),
(12, 19, 1, 3, '2018-03-06 08:00:00', '2018-03-06 08:00:00', '2018-06-14 22:34:46', 'Rua Teste, 999', 'Boa Viagem', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-03-06 08:00:00', 4, NULL),
(13, 20, 2, 1, '2018-03-07 08:00:00', '2018-03-07 08:00:00', '2018-06-14 22:37:22', 'Rua Teste, 999', 'Boa Viagem', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-07 08:00:00', 5, NULL),
(14, 21, 3, 2, '2018-03-08 08:00:00', '2018-03-08 08:00:00', '2018-06-14 22:38:31', 'Rua Teste, 999', 'Boa Viagem', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-08 08:00:00', 5, NULL),
(15, 22, 4, 3, '2018-03-09 08:00:00', '2018-03-09 08:00:00', '2018-06-14 22:39:00', 'Rua Teste, 999', 'Boa Viagem', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-03-09 08:00:00', 5, NULL),
(16, 23, 5, 1, '2018-03-10 08:00:00', '2018-03-10 08:00:00', '2018-06-14 22:43:22', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-10 08:00:00', 4, NULL),
(17, 24, 1, 2, '2018-03-11 08:00:00', '2018-03-11 08:00:00', '2018-06-14 22:44:38', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-11 08:00:00', 3, NULL),
(18, 25, 2, 3, '2018-03-12 08:00:00', '2018-03-12 08:00:00', '2018-06-14 22:45:24', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-03-12 08:00:00', 4, NULL),
(19, 26, 3, 1, '2018-03-13 08:00:00', '2018-03-13 08:00:00', '2018-06-14 22:47:33', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-13 08:00:00', 5, NULL),
(20, 27, 4, 2, '2018-03-14 08:00:00', '2018-03-14 08:00:00', '2018-06-14 22:48:25', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 40, 0, 4, 'C', 'S', '', '2018-03-14 08:00:00', 2, NULL),
(21, 28, 5, 3, '2018-03-15 08:00:00', '2018-03-15 08:00:00', '2018-06-14 22:48:55', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 80, 0, 4, 'C', 'S', '', '2018-03-15 08:00:00', 3, NULL),
(22, 30, 2, 2, '2018-04-01 08:00:00', '2018-04-01 08:00:00', '2018-06-14 23:16:20', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-01 08:00:00', 5, NULL),
(23, 31, 3, 3, '2018-04-02 08:00:00', '2018-04-02 08:00:00', '2018-06-14 23:17:25', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-02 08:00:00', 5, NULL),
(24, 32, 4, 1, '2018-04-03 08:00:00', '2018-04-03 08:00:00', '2018-06-14 23:18:00', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-03 08:00:00', 4, NULL),
(25, 33, 5, 2, '2018-04-04 08:00:00', '2018-04-04 08:00:00', '2018-06-14 23:18:42', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-04 08:00:00', 4, NULL),
(27, 14, 1, 3, '2018-04-05 08:00:00', '2018-04-05 08:00:00', '2018-06-14 23:20:56', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-05 08:00:00', 3, NULL),
(28, 14, 2, 1, '2018-04-06 08:00:00', '2018-04-06 08:00:00', '2018-06-14 23:21:29', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-06 08:00:00', 5, NULL),
(29, 15, 3, 2, '2018-04-07 08:00:00', '2018-04-07 08:00:00', '2018-06-14 23:22:43', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-07 08:00:00', 4, NULL),
(30, 16, 4, 3, '2018-04-08 08:00:00', '2018-04-08 08:00:00', '2018-06-14 23:23:13', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-08 08:00:00', 4, NULL),
(31, 17, 5, 1, '2018-04-09 08:00:00', '2018-04-09 08:00:00', '2018-06-14 23:23:55', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-09 08:00:00', 5, NULL),
(32, 18, 1, 2, '2018-04-10 08:00:00', '2018-04-10 08:00:00', '2018-06-14 23:24:35', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-10 08:00:00', 1, NULL),
(33, 18, 1, 2, '2018-04-10 08:00:00', '2018-04-10 08:00:00', '2018-06-14 23:25:21', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-10 08:00:00', 2, NULL),
(34, 19, 2, 3, '2018-04-11 08:00:00', '2018-04-11 08:00:00', '2018-06-14 23:25:44', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-11 08:00:00', 4, NULL),
(35, 20, 3, 1, '2018-04-12 08:00:00', '2018-04-12 08:00:00', '2018-06-14 23:27:27', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-12 08:00:00', 3, NULL),
(36, 21, 4, 2, '2018-04-13 08:00:00', '2018-04-13 08:00:00', '2018-06-14 23:28:26', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-13 08:00:00', 5, NULL),
(37, 22, 5, 3, '2018-04-14 08:00:00', '2018-04-14 08:00:00', '2018-06-14 23:28:50', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'C', 80, 0, 0, 'P', 'N', '', NULL, NULL, NULL),
(38, 23, 1, 1, '2018-04-15 08:00:00', '2018-04-15 08:00:00', '2018-06-14 23:30:13', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'C', 40, 0, 0, 'P', 'S', '', NULL, NULL, NULL),
(39, 24, 2, 2, '2018-04-16 08:00:00', '2018-04-16 08:00:00', '2018-06-14 23:30:33', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'C', 40, 0, 0, 'P', 'N', '', NULL, NULL, NULL),
(40, 25, 3, 3, '2018-04-17 08:00:00', '2018-04-17 08:00:00', '2018-06-14 23:30:55', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-17 08:00:00', 4, NULL),
(41, 26, 4, 1, '2018-04-18 08:00:00', '2018-04-18 08:00:00', '2018-06-14 23:31:28', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-18 08:00:00', 4, NULL),
(42, 27, 5, 2, '2018-04-19 08:00:00', '2018-04-19 08:00:00', '2018-06-14 23:34:16', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-19 08:00:00', 4, NULL),
(43, 28, 1, 3, '2018-04-20 08:00:00', '2018-04-20 08:00:00', '2018-06-14 23:35:31', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-20 08:00:00', 3, NULL),
(44, 29, 2, 1, '2018-04-21 08:00:00', '2018-04-21 08:00:00', '2018-06-14 23:35:58', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-21 08:00:00', 4, NULL),
(45, 30, 2, 2, '2018-05-01 08:00:00', '2018-05-01 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-01 08:00:00', 5, NULL),
(46, 31, 3, 3, '2018-05-02 08:00:00', '2018-05-02 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-02 08:00:00', 5, NULL),
(47, 32, 4, 1, '2018-05-03 08:00:00', '2018-05-03 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-03 08:00:00', 4, NULL),
(48, 33, 5, 2, '2018-05-04 08:00:00', '2018-05-04 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-04 08:00:00', 4, NULL),
(49, 14, 1, 3, '2018-05-05 08:00:00', '2018-05-05 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-05 08:00:00', 3, NULL),
(50, 14, 2, 1, '2018-05-06 08:00:00', '2018-05-06 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Imbiribeira', '51170570', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-06 08:00:00', 5, NULL),
(51, 15, 3, 2, '2018-05-07 08:00:00', '2018-05-07 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-07 08:00:00', 4, NULL),
(52, 16, 4, 3, '2018-05-08 08:00:00', '2018-05-08 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-08 08:00:00', 4, NULL),
(53, 17, 5, 1, '2018-05-09 08:00:00', '2018-05-09 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-09 08:00:00', 5, NULL),
(54, 18, 1, 2, '2018-05-10 08:00:00', '2018-05-10 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-10 08:00:00', 1, NULL),
(55, 18, 1, 2, '2018-05-10 08:00:00', '2018-05-10 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-10 08:00:00', 2, NULL),
(56, 19, 2, 3, '2018-05-11 08:00:00', '2018-05-11 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-11 08:00:00', 4, NULL),
(57, 20, 3, 1, '2018-05-12 08:00:00', '2018-05-12 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-12 08:00:00', 3, NULL),
(58, 21, 4, 2, '2018-05-13 08:00:00', '2018-05-13 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-13 08:00:00', 5, NULL),
(59, 22, 5, 3, '2018-05-14 08:00:00', '2018-05-14 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Boa Viagen', '51021010', 2611606, 'C', 80, 0, 0, 'P', 'N', '', NULL, NULL, NULL),
(60, 23, 1, 1, '2018-05-15 08:00:00', '2018-05-15 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'C', 40, 0, 0, 'P', 'S', '', NULL, NULL, NULL),
(61, 24, 2, 2, '2018-05-16 08:00:00', '2018-05-16 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'C', 40, 0, 0, 'P', 'N', '', NULL, NULL, NULL),
(62, 25, 3, 3, '2018-05-17 08:00:00', '2018-05-17 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-17 08:00:00', 4, NULL),
(63, 26, 4, 1, '2018-05-18 08:00:00', '2018-05-18 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'C', 40, 0, 0, 'P', 'S', '', NULL, NULL, NULL),
(64, 27, 5, 2, '2018-05-19 08:00:00', '2018-05-19 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-19 08:00:00', 4, NULL),
(65, 28, 1, 3, '2018-05-20 08:00:00', '2018-05-20 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 80, 0, 4, 'C', 'S', '', '2018-05-20 08:00:00', 3, NULL),
(66, 29, 2, 1, '2018-05-21 08:00:00', '2018-05-21 08:00:00', '2018-06-15 00:01:48', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 40, 0, 4, 'C', 'S', '', '2018-05-21 08:00:00', 4, NULL),
(76, 30, 3, 2, '2018-04-22 08:00:00', '2018-04-22 08:00:00', '2018-06-15 00:03:51', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-22 08:00:00', 5, NULL),
(77, 31, 4, 3, '2018-04-23 08:00:00', '2018-04-23 08:00:00', '2018-06-15 00:04:16', 'Rua Teste, 999', 'Piedade', '54420700', 2607901, 'R', 80, 0, 4, 'C', 'S', '', '2018-04-23 08:00:00', 5, NULL),
(78, 32, 5, 1, '2018-04-24 08:00:00', '2018-04-24 08:00:00', '2018-06-15 00:05:10', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-24 08:00:00', 5, NULL),
(79, 33, 1, 2, '2018-04-25 08:00:00', '2018-04-25 08:00:00', '2018-06-15 00:05:31', 'Rua Teste, 999', 'IPSEP', '51190970', 2611606, 'R', 40, 0, 4, 'C', 'S', '', '2018-04-25 08:00:00', 5, NULL);
...
`cli_id` int(11) NOT NULL,
  ...
  `cli_ultimo_acesso` datetime NOT NULL,
  `cli_uniqid` char(32) NOT NULL,
  `cli_data_confirmacao` datetime NOT NULL,
  `cli_status` char(1) NOT NULL DEFAULT 'I'
...
INSERT INTO `tb_cliente` (`cli_id`, `cli_nome`, `cli_login`, `cli_senha`, `cli_data_nascimento`, `cli_sexo`, `cli_email`, `cli_ddd`, `cli_telefone`, `cli_endereco`, `cli_bairro`, `cli_cep`, `mun_id`, `cli_data_cad`, `cli_ultimo_acesso`, `cli_uniqid`, `cli_data_confirmacao`, `cli_status`) VALUES
(2, 'Nome do Cliente', 'login', '60a156bb175722a22f2d97e6dd6bb762', '1990-02-01', 'M', 'teste@teste.com', '81', '33334444', 'Rua teste, 123', 'Imbiribeira', '51111222', 2611606, '2018-05-20 21:03:25', '0000-00-00 00:00:00', 'abcdf', '0000-00-00 00:00:00', 'A'),
(14, 'Filipe', 'filipegame07', 'e10adc3949ba59abbe56e057f20f883e', '0000-00-00', 'M', 'filipegame07@gmail.com', '81', '996927685', 'Rua Paraná', 'Piedade', '54420700', 2607901, '2018-05-29 01:06:01', '0000-00-00 00:00:00', 'abcdf', '0000-00-00 00:00:00', 'A'),
(15, 'Margareth Souza de Oliveira', 'msoliveira', '60a156bb175722a22f2d97e6dd6bb762', '1965-03-15', 'F', 'msoliveira@teste.com', '81', '33330001', 'Rua Jean Emily Favre, 001', 'IPSEP', '51190970', 2611606, '2018-06-13 21:45:35', '0000-00-00 00:00:00', '3d0eb80ad1ec046ad8fca3253bb7b64a', '0000-00-00 00:00:00', 'A'),
(16, 'Jurema Bezerra Gomes', 'jbgomes', '60a156bb175722a22f2d97e6dd6bb762', '1966-04-16', 'F', 'jbgomes@teste.com', '81', '33330002', 'Rua Jean Emily Favre, 002', 'IPSEP', '51190970', 2611606, '2018-06-13 21:47:07', '0000-00-00 00:00:00', '063f92e14be8e9f347df7f6d0157f3cd', '0000-00-00 00:00:00', 'A'),
(17, 'Cremilda Rodrigues da Silva', 'crsilva', '60a156bb175722a22f2d97e6dd6bb762', '1961-05-17', 'F', 'crsilva@teste.com', '81', '33330003', 'Rua Jean Emily Favre, 003', 'IPSEP', '51190970', 2611606, '2018-06-13 21:48:30', '0000-00-00 00:00:00', '02e88d6dd6f21bf75236b7ddd158f589', '0000-00-00 00:00:00', 'A'),
(18, 'Gertrud Rutz Knobel', 'grknobel', '60a156bb175722a22f2d97e6dd6bb762', '1955-06-18', 'F', 'grknobel@teste.com', '81', '33330004', 'Rua Jean Emily Favre, 004', 'IPSEP', '51190970', 2611606, '2018-06-13 21:55:10', '0000-00-00 00:00:00', '14731553ae0cef71de1bf7321ca3fdcf', '0000-00-00 00:00:00', 'A'),
(19, 'Natália Miranda de Andrade', 'nmandrade', '60a156bb175722a22f2d97e6dd6bb762', '1985-07-19', 'F', 'nmandrade@teste.com', '81', '33330005', 'Rua Jean Emily Favre, 005', 'IPSEP', '51190970', 2611606, '2018-06-13 21:56:56', '0000-00-00 00:00:00', 'f9a0cf33f453a51c9c24c8fe636aa393', '0000-00-00 00:00:00', 'A'),
(20, 'Marina Lira Sampaio', 'mlsampaio', '60a156bb175722a22f2d97e6dd6bb762', '1980-08-20', 'F', 'mlsampaio@teste.com', '81', '33330006', 'Rua dos Navegantes, 001', 'Boa Viagem', '51021010', 2611606, '2018-06-13 22:24:22', '0000-00-00 00:00:00', '3d342bd236284da366ea398f105f769c', '0000-00-00 00:00:00', 'A'),
(21, 'Tássia Fernandes de Barros', 'tfbarros', '60a156bb175722a22f2d97e6dd6bb762', '1987-09-21', 'F', 'tfbarros@teste.com', '81', '33330007', 'Rua dos Navegantes, 002', 'Boa Viagem', '51021010', 2611606, '2018-06-13 22:27:04', '0000-00-00 00:00:00', 'dd15347adfae62a290dba9596327097a', '0000-00-00 00:00:00', 'A'),
(22, 'Fernanda Sales de Moura', 'fsmoura', '60a156bb175722a22f2d97e6dd6bb762', '1985-10-22', 'F', 'fsmoura@teste.com', '81', '33330008', 'Rua dos Navegantes, 003', 'Boa Viagem', '51021010', 2611606, '2018-06-13 22:28:28', '0000-00-00 00:00:00', '25a585eb724c5130228391e9c94a37e9', '0000-00-00 00:00:00', 'A'),
(23, 'Roberta Maria de Almeira', 'rmalmeida', '60a156bb175722a22f2d97e6dd6bb762', '1981-11-23', 'F', 'rmalmeida@teste.com', '81', '33330009', 'Rua dos Navegantes, 004', 'Boa Viagem', '51021010', 2611606, '2018-06-13 22:30:10', '0000-00-00 00:00:00', '1ed9a3eedd053f503b3fb0de12961bcc', '0000-00-00 00:00:00', 'A'),
(24, 'Rosemery Tavares Magalhães', 'rtmagalhaes', '60a156bb175722a22f2d97e6dd6bb762', '1974-12-24', 'F', 'rtmagalhaes@teste.com', '81', '33330010', 'Rua dos Navegantes, 005', 'Boa Viagem', '51021010', 2611606, '2018-06-13 22:32:36', '0000-00-00 00:00:00', '261632cccd3127eca27ee446cf874fc5', '0000-00-00 00:00:00', 'A'),
(25, 'Marli Galdino Benevides', 'mgbenevides', '60a156bb175722a22f2d97e6dd6bb762', '1959-01-25', 'F', 'mgbenevides@teste.com', '81', '33330011', 'Rua Zeferino Pinho, 001', 'Imbiribeira', '51170570', 2611606, '2018-06-13 22:36:20', '0000-00-00 00:00:00', '62b266e74768f0a0ff39b13c527ae511', '0000-00-00 00:00:00', 'A'),
(26, 'Mariana Torres Motta', 'mtmotta', '60a156bb175722a22f2d97e6dd6bb762', '1992-02-26', 'F', 'mtmotta@teste.com', '81', '33330012', 'Rua Zeferino Pinho, 002', 'Imbiribeira', '51170570', 2611606, '2018-06-13 22:39:27', '0000-00-00 00:00:00', 'efd90c4c3118af32a7da3d61b08ad709', '0000-00-00 00:00:00', 'A'),
(27, 'Maria Luísa Dantas Barreto', 'mlbarreto', '60a156bb175722a22f2d97e6dd6bb762', '1984-03-27', 'F', 'mlbarreto@teste.com', '81', '33330013', 'Rua Zeferino Pinho, 003', 'Imbiribeira', '51170570', 2611606, '2018-06-13 22:41:01', '0000-00-00 00:00:00', '5bf19da135f6b93d6cd5735f6463fbdb', '0000-00-00 00:00:00', 'A'),
(28, 'Teresa Resende Coelho', 'trcoelho', '60a156bb175722a22f2d97e6dd6bb762', '1979-04-28', 'F', 'trcoelho@teste.com', '81', '33330014', 'Rua Zeferino Pinho, 004', 'Imbiribeira', '51170570', 2611606, '2018-06-13 22:42:19', '0000-00-00 00:00:00', '9ec4ec48a1df53fbd111de60dfd16a50', '0000-00-00 00:00:00', 'A'),
(29, 'Daniella Moreira Franco', 'dmfranco', '60a156bb175722a22f2d97e6dd6bb762', '1982-05-29', 'F', 'dmfranco@teste.com', '81', '33330015', 'Rua Zeferino Pinho, 005', 'Imbiribeira', '51170570', 2611606, '2018-06-13 22:43:43', '0000-00-00 00:00:00', '5f69f1bf089905fdb67b115ed948570e', '0000-00-00 00:00:00', 'A'),
(30, 'Cristine Santos Rocha', 'csrocha', '60a156bb175722a22f2d97e6dd6bb762', '1973-06-30', 'F', 'csrocha@teste.com', '81', '33330016', 'Av Ayrton Senna, 001', 'Piedade', '54420700', 2607901, '2018-06-13 22:51:38', '0000-00-00 00:00:00', '7a9cf3efa0adaff179894715520332cc', '0000-00-00 00:00:00', 'A'),
(31, 'Lorena Brasil Nunes', 'lbnunes', '60a156bb175722a22f2d97e6dd6bb762', '1991-07-01', 'F', 'lbnunes@teste.com', '81', '33330017', 'Av Ayrton Senna, 002', 'Piedade', '54420700', 2607901, '2018-06-13 22:52:58', '0000-00-00 00:00:00', 'd5e4152cce2d7013d03304023a1be8a9', '0000-00-00 00:00:00', 'A'),
(32, 'Renata Diniz Costa', 'rdcosta', '60a156bb175722a22f2d97e6dd6bb762', '1994-08-02', 'F', 'rdcosta@teste.com', '81', '33330018', 'Av Ayrton Senna, 003', 'Piedade', '54420700', 2607901, '2018-06-13 22:54:30', '0000-00-00 00:00:00', 'b7e2dd551a04a55446b742dac7c45115', '0000-00-00 00:00:00', 'A'),
(33, 'Inêz Nobre Monteiro', 'inmonteiro', '60a156bb175722a22f2d97e6dd6bb762', '1978-09-03', 'F', 'inmonteiro@teste.com', '81', '33330019', 'Av Ayrton Senna, 004', 'Piedade', '54420700', 2607901, '2018-06-13 22:55:56', '0000-00-00 00:00:00', '23d4f4f5be19cc4f96d75856599cdc81', '0000-00-00 00:00:00', 'A');
...
INSERT INTO `tb_estado` (`est_uf`, `est_nome`) VALUES
('AC', 'Acre'),
('AL', 'Alagoas'),
('AM', 'Amazonas'),
('AP', 'Amapá'),
...
`fp_id` int(11) NOT NULL,
  `fp_descricao` varchar(50) NOT NULL
...
INSERT INTO `tb_forma_pagamento` (`fp_id`, `fp_descricao`) VALUES
(1, 'Dinheiro'),
(2, 'Cartão');
...
INSERT INTO `tb_pagamento` (`pag_id`, `atd_id`, `pag_valor`, `fp_id`, `pag_data`) VALUES
(1, 2, 100, 2, '2018-06-09 00:00:00'),
(2, 3, 0, 2, '0000-00-00 00:00:00'),
(3, 4, 0, 2, '0000-00-00 00:00:00'),
(4, 5, 0, 2, '0000-00-00 00:00:00'),
(5, 6, 50, 2, '2018-06-12 00:00:00'),
(6, 9, 80, 2, '2018-03-03 08:00:00'),
(7, 10, 40, 2, '2018-03-04 08:00:00'),
(8, 11, 40, 2, '2018-03-05 08:00:00'),
(9, 12, 80, 2, '2018-03-06 08:00:00'),
(10, 13, 40, 2, '2018-03-07 08:00:00'),
(11, 14, 40, 2, '2018-03-08 08:00:00'),
(12, 15, 80, 2, '2018-03-09 08:00:00'),
(13, 16, 40, 2, '2018-03-10 08:00:00'),
(14, 17, 40, 2, '2018-03-11 08:00:00'),
(15, 18, 80, 2, '2018-03-12 08:00:00'),
(16, 19, 40, 2, '2018-03-13 08:00:00'),
(17, 20, 40, 2, '2018-03-14 08:00:00'),
(18, 21, 80, 2, '2018-03-15 08:00:00'),
(19, 22, 40, 2, '2018-04-01 08:00:00'),
(20, 23, 80, 2, '2018-04-02 08:00:00'),
(21, 24, 40, 2, '2018-04-03 08:00:00'),
(22, 25, 40, 2, '2018-04-04 08:00:00'),
(23, 27, 80, 2, '2018-04-05 08:00:00'),
(24, 28, 40, 2, '2018-04-06 08:00:00'),
(25, 29, 40, 2, '2018-04-07 08:00:00'),
(26, 30, 80, 2, '2018-04-08 08:00:00'),
(27, 31, 40, 2, '2018-04-09 08:00:00'),
(28, 32, 40, 2, '2018-04-10 08:00:00'),
(29, 33, 40, 2, '2018-04-10 08:00:00'),
(30, 34, 80, 2, '2018-04-11 08:00:00'),
(31, 35, 40, 2, '2018-04-12 08:00:00'),
(32, 36, 40, 2, '2018-04-13 08:00:00'),
(33, 40, 80, 2, '2018-04-17 08:00:00'),
(34, 41, 40, 2, '2018-04-18 08:00:00'),
(35, 42, 40, 2, '2018-04-19 08:00:00'),
(36, 43, 80, 2, '2018-04-20 08:00:00'),
(37, 44, 40, 2, '2018-04-21 08:00:00'),
(38, 45, 40, 2, '2018-05-01 08:00:00'),
(39, 46, 80, 2, '2018-05-02 08:00:00'),
(40, 47, 40, 2, '2018-05-03 08:00:00'),
(41, 48, 40, 2, '2018-05-04 08:00:00'),
(42, 49, 80, 2, '2018-05-05 08:00:00'),
(43, 50, 40, 2, '2018-05-06 08:00:00'),
(44, 51, 40, 2, '2018-05-07 08:00:00'),
(45, 52, 80, 2, '2018-05-08 08:00:00'),
(46, 53, 40, 2, '2018-05-09 08:00:00'),
(47, 54, 40, 2, '2018-05-10 08:00:00'),
(48, 55, 40, 2, '2018-05-10 08:00:00'),
(49, 56, 80, 2, '2018-05-11 08:00:00'),
(50, 57, 40, 2, '2018-05-12 08:00:00'),
(51, 58, 40, 2, '2018-05-13 08:00:00'),
(52, 62, 80, 2, '2018-05-17 08:00:00'),
(53, 64, 40, 2, '2018-05-19 08:00:00'),
(54, 65, 80, 2, '2018-05-20 08:00:00'),
(55, 66, 40, 2, '2018-05-21 08:00:00'),
(56, 76, 40, 2, '2018-04-22 08:00:00'),
(57, 77, 80, 2, '2018-04-23 08:00:00'),
(58, 78, 40, 2, '2018-04-24 08:00:00'),
(59, 79, 40, 2, '2018-04-25 08:00:00');
...
`pro_id` int(11) NOT NULL,
  ...
  `pro_login` varchar(30) NOT NULL,
  `pro_senha` char(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `pro_data_nascimento` date NOT NULL,
  `pro_sexo` char(1) NOT NULL,
  `pro_email` varchar(70) NOT NULL,
  `pro_ddd` char(2) NOT NULL,
  `pro_telefone` varchar(10) NOT NULL,
  `pro_endereco` varchar(255) NOT NULL,
  `pro_bairro` varchar(50) NOT NULL,
  `pro_cep` char(8) NOT NULL,
  `mun_id` int(11) NOT NULL,
  `pro_data_cad` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pro_ultimo_acesso` datetime NOT NULL,
  `pro_uniqid` char(32) NOT NULL,
  `pro_data_confirmacao` datetime NOT NULL,
  `pro_status` char(1) NOT NULL DEFAULT 'I'
...
INSERT INTO `tb_profissional` (`pro_id`, `pro_nome`, `pro_login`, `pro_senha`, `pro_data_nascimento`, `pro_sexo`, `pro_email`, `pro_ddd`, `pro_telefone`, `pro_endereco`, `pro_bairro`, `pro_cep`, `mun_id`, `pro_data_cad`, `pro_ultimo_acesso`, `pro_uniqid`, `pro_data_confirmacao`, `pro_status`) VALUES
(1, 'Josefa Maria', 'josefamaria', '123456', '1970-03-20', 'F', 'josefamaria@provedor.com', '81', '999999666', 'Rua Agenor Lopes', 'Entra Apulso', '54000000', 2611606, '2018-05-29 01:55:15', '1970-03-20 00:00:00', '', '1970-03-20 00:00:00', 'A'),
(2, 'Cleide de Araújo Gama', 'cagama', '123@teste', '1990-02-01', 'F', 'teste@teste.com', '81', '33334444', 'Rua teste, 123', 'Imbiribeira', '51111222', 2611606, '2018-06-02 19:05:48', '0000-00-00 00:00:00', 'd49e65d5e8469c233a3ccb6a7db03597', '0000-00-00 00:00:00', 'A'),
(3, 'Marleide da SIlva', 'marleidedasilva', '123456', '1968-09-12', 'F', 'marleides@email.com', '81', '999999667', 'Rua Alameda das Hortências', 'Piedade', '54420-72', 2607901, '2018-06-12 13:16:58', '2018-06-12 13:16:58', '', '2018-06-12 13:16:58', 'A'),
(4, 'Vanessa Carneiro Leão', 'cvleao', '123@teste', '1990-10-04', 'F', 'cvleao@teste.com', '81', '33330020', 'Rua Jean Emily Favre, 101', 'IPSEP', '51190970', 2611606, '2018-06-13 23:05:26', '0000-00-00 00:00:00', 'cfc04a9b81c834edab8fa9b8ca9a2d68', '0000-00-00 00:00:00', 'A'),
(5, 'Valentina Moreira Mello', 'vmmello', '123@teste', '1988-11-05', 'F', 'vmmello@teste.com', '81', '33330021', 'Rua dos Navegantes, 101', 'Boa Viagem', '51021010', 2611606, '2018-06-13 23:08:38', '0000-00-00 00:00:00', '802be96162e175f7f82aea932e311339', '0000-00-00 00:00:00', 'A');
...
`ser_id` int(11) NOT NULL,
  ...
  `ser_custo_base` double NOT NULL,
...
INSERT INTO `tb_servico` (`ser_id`, `ser_descricao`, `ser_custo_base`, `ser_status`) VALUES
(1, 'Design de Sobrancelhas', 25, 'A'),
(2, 'Manicure', 25, 'A'),
(3, 'Unhas', 50, 'A');
...
ALTER TABLE `tb_atendimento`
 ADD PRIMARY KEY (`atd_id`), ADD KEY `IND_ATD_CLI_ID` (`cli_id`), ADD KEY `IND_ATD_PRO_ID` (`pro_id`), ADD KEY `IND_ATD_SER_ID` (`ser_id`), ADD KEY `IND_ATD_MUN_ID` (`mun_id`);

--
-- Indexes for table `tb_cliente`
--
ALTER TABLE `tb_cliente`
 ADD PRIMARY KEY (`cli_id`), ADD UNIQUE KEY `UNQ_CLI_LOGIN` (`cli_login`), ADD KEY `IND_CLI_MUN_ID` (`mun_id`);

--
-- Indexes for table `tb_estado`
--
ALTER TABLE `tb_estado`
 ADD PRIMARY KEY (`est_uf`);
...
ALTER TABLE `tb_municipio`
 ADD PRIMARY KEY (`mun_id`), ADD KEY `est_uf` (`est_uf`);

--
-- Indexes for table `tb_pagamento`
--
ALTER TABLE `tb_pagamento`
 ADD PRIMARY KEY (`pag_id`), ADD KEY `IND_PAG_ATD_ID` (`atd_id`), ADD KEY `IND_PAG_FP_ID` (`fp_id`);

--
-- Indexes for table `tb_profissional`
--
ALTER TABLE `tb_profissional`
 ADD PRIMARY KEY (`pro_id`), ADD UNIQUE KEY `UNQ_PRO_LOGIN` (`pro_login`), ADD KEY `IND_PRO_MUN_ID` (`mun_id`);
...
--
ALTER TABLE `tb_atendimento`
MODIFY `atd_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
-- AUTO_INCREMENT for table `tb_cliente`
--
ALTER TABLE `tb_cliente`
MODIFY `cli_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `tb_pagamento`
MODIFY `pag_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=64;
--
...
--
ALTER TABLE `tb_atendimento`
ADD CONSTRAINT `FK_ATD_CLI_ID` FOREIGN KEY (`cli_id`) REFERENCES `tb_cliente` (`cli_id`),
ADD CONSTRAINT `FK_ATD_MUN_ID` FOREIGN KEY (`mun_id`) REFERENCES `tb_municipio` (`mun_id`),
ADD CONSTRAINT `FK_ATD_PRO_ID` FOREIGN KEY (`pro_id`) REFERENCES `tb_profissional` (`pro_id`),
ADD CONSTRAINT `FK_ATD_SER_ID` FOREIGN KEY (`ser_id`) REFERENCES `tb_servico` (`ser_id`);

--
-- Limitadores para a tabela `tb_cliente`
--
ALTER TABLE `tb_cliente`
ADD CONSTRAINT `FK_CLI_MUN_ID` FOREIGN KEY (`mun_id`) REFERENCES `tb_municipio` (`mun_id`);

--
-- Limitadores para a tabela `tb_municipio`
--
ALTER TABLE `tb_municipio`
ADD CONSTRAINT `FK_MUN_EST_UF` FOREIGN KEY (`est_uf`) REFERENCES `tb_estado` (`est_uf`);

--
-- Limitadores para a tabela `tb_pagamento`
--
ALTER TABLE `tb_pagamento`
ADD CONSTRAINT `FK_PAG_ATD_ID` FOREIGN KEY (`atd_id`) REFERENCES `tb_atendimento` (`atd_id`),
ADD CONSTRAINT `FK_PAG_FP_ID` FOREIGN KEY (`fp_id`) REFERENCES `tb_forma_pagamento` (`fp_id`);

--
-- Limitadores para a tabela `tb_profissional`
--
ALTER TABLE `tb_profissional`
ADD CONSTRAINT `FK_PRO_MUN_ID` FOREIGN KEY (`mun_id`) REFERENCES `tb_municipio` (`mun_id`);
